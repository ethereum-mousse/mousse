...
use crate::eth2_types::{Epoch, Gwei, Root, Slot, H256};
...
pub const GASPRICE_ADJUSTMENT_QUOTIENT: u64 =
    SHARD_NUM as u64 * SLOTS_PER_EPOCH * GASPRICE_ADJUSTMENT_COEFFICIENT;
